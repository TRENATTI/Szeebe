...
const GroupTypeLibrarySingleParam = ["getGroup"];
...
module.exports = {
	...
	async execute(interaction, noblox, admin) {
		...
		const isReady = db.ref(
			"szeebe/alapha-universe-docs-signature/Groups/getGroup"
		);
					...
					setTimeout(async function timer() {
						...
						async function continueGroupData(
							...
							if (Flag == true) {
								...
								var newdatajsonstring =
									JSON.stringify(newdatajson);
