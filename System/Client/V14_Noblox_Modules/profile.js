...
module.exports = {
	...
	async execute(interaction, noblox) {
		...
		console.log(new Date(), `| profile.js |`, interactionStringArg);
		...
		if (!interactionStringArg) {
			axios
				...
				.catch((error) =>
					console.log(new Date(), `| profile.js |`, error)
				);
		} else {
			...
			axios
				...
				.then(function (response) {
					console.log(new Date(), `| profile.js |`, response.data);
					if (response.data.data.length == 0) {
						...
						console.log(new Date(), `| profile.js |`, embed);
